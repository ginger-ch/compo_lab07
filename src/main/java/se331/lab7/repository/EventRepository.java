...
public interface EventRepository extends JpaRepository<Event, Long> {
    ...
    Page<Event> findByTitleContainingIgnoreCaseOrDescriptionContainingIgnoreCaseOrOrganizer_NameContainingIgnoreCase(String title, String description, String organizerName,Pageable pageRequest);
}
